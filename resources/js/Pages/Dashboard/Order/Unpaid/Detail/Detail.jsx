...
const Detail = ({ invoice }) => {
    return (
        <div className="my-4">
            <PrimaryButton className="align-top mr-3"><Link className="flex" href={route('order.unpaid.index')}><BsBack className="mr-2" /> Back</Link></PrimaryButton>
            {invoice.method == 'cash' && <PrimaryButton className="flex mr-3" onClick={(e) => handlePayment(e, invoice.order)}><BsWallet2 className="mr-2" /> Paid</PrimaryButton>}
