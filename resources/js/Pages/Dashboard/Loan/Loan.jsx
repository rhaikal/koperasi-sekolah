...
const Loan = ({ loans, query, auth }) => {
    ...
    return (
        <div className="min-w-0 p-4 overflow-x-auto rounded-lg shadow-lg">
            <a className={primaryButtonClass + ` w-fit ${_.isEmpty(loans?.data) && 'pointer-events-none cursor-default bg-indigo-400'}`} href={route('exported.loans')}><MdPictureAsPdf className="mr-2 w-4 h-4" /> Export</a>
