    ...
    return (
        <div className="min-w-0 p-4 pt-8 overflow-x-auto rounded-lg shadow-lg">
            <div className="flex justify-between my-4">
                ...
                <PrimaryButton className="text-gray-500"><Link href={"/"}>Create Loan</Link></PrimaryButton>
            </div>
            <Table>
                <Table.Head>
                ...
                <Table.Body>
                    {!_.isEmpty(loans?.data) ? loans.data.map((loan) => (
                        ...
                        <Table.Row>
                            <Table.Content type="header" colSpan={"5"} className="text-center text-base text-gray-500 font-semibold italic">Loans Not Found</Table.Content>
                        </Table.Row>
                    }
                </Table.Body>
            </Table>
