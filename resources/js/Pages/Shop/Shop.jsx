            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-md sm:rounded-lg">
                        <div>
                            <ProductFilter subCategories={props.categories} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} />
                            ...
                            <section aria-labelledby="products-heading" className="pt-6 pb-6">
                                ...
                                <div className="lg:col-span-3">
                                    <ProductList products={props.products.data} links={props.products} />
                                </div>
                                </div>
                            </section>
                            </main>
