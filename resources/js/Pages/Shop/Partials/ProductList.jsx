                    ...
                    {products.map((product) => (
                        <div key={product.id} className="flex justify-between flex-col product-item overflow-hidden group shadow-lg p-2">
                            ...
                            <div className="relative product-item-pic aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-w-7 xl:aspect-h-8">
                                ...
                                className="h-full w-full border border-gray-200 rounded-lg object-cover object-center group-hover:opacity-75"
                                />
                                <ul className="product-hover absolute top-6 right-[-200px] cursor-pointer transition-all duration-700">
                                    <li className="bg-gray-100 p-1 rounded border border-stone-400">
                                        <BiSearch className="w-7 h-7 lg:h-5 lg:w-5 text-stone-400" />
                                    </li>
                                </ul>
                            </div>
                            <div className="product-item-text relative pt-6">
                                <a href="#" className="absolute z-50 top-0 left-0 add-cart no-underline opacity-0 text-lg lg:text-base font-semibold text-indigo-500 transition-all duration-500">+ Add To Cart</a>
